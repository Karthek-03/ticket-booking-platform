...
// Sample Fallback Data for Static Vercel Demo
const sampleDemoEvents = [
    {
        id: 1,
        title: "Tech Conference 2026",
        description: "Annual software engineering & AI innovation summit.",
    ...
    },
    {
        ...
        description: "Live symphony orchestra and modern acoustic performance.",
    ...
    },
    {
        ...
        description: "Exclusive IMAX 3D red carpet movie premiere.",
    ...
    },
    {
        ...
        description: "An evening of non-stop laughter featuring top comedians.",
    ...
    },
    {
        ...
        description: "Live stadium finals tournament match.",
...
async function loadEvents() {
    try {
        ...
        console.warn('API backend not connected, rendering demo events dataset:', err);
        allEventsCache = sampleDemoEvents;
        renderEvents(allEventsCache);
    }
}
...
function renderEvents(events) {
    ...
    const html = events.map(evt => `
        <div class="event-card">
            <img src="${evt.imageUrl || 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800'}" class="event-card-img" alt="${evt.title}" />
            <div class="event-card-body">
                ...
                <div class="event-meta">
                    ...
                    <div style="margin-top:0.4rem;">
                        <span class="badge ${evt.availableSeats > 0 ? 'badge-success' : 'badge-danger'}">
                            ${evt.availableSeats > 0 ? `${evt.availableSeats} seats left` : 'Sold Out'}
                        </span>
                    </div>
                </div>
                <div class="event-card-footer">
                    <div class="event-price">₹${evt.ticketPrice}</div>
...
async function submitBooking() {
    ...
    try {
        ...
        try {
            ...
            // Static demo mode fallback booking
            b = {
                bookingReference: "TB-2026-" + Math.random().toString(36).substring(2, 8).toUpperCase(),
                eventTitle: selectedEventForBooking.title,
                quantity: bookingQuantity,
                totalAmount: (selectedEventForBooking.ticketPrice * bookingQuantity).toFixed(2)
            };
        }
...
async function loadAdminBookings(status) {
    ...
    tbody.innerHTML = bookings.map(b => `
        <tr>
            ...
            <td>${b.quantity}</td>
            <td>₹${b.totalAmount}</td>
            <td><span class="badge ${b.bookingStatus === 'CONFIRMED' ? 'badge-success' : 'badge-danger'}">${b.bookingStatus}</span></td>
